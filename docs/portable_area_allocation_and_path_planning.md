...
알고리즘, 수식, 유사코드, 결정성(tie-break) 규칙을 정리한다. 원본 구현은
[`src/scopp/algorithm/clustering.py`](../src/scopp/algorithm/clustering.py),
[`src/scopp/algorithm/clustering_profiles.py`](../src/scopp/algorithm/clustering_profiles.py),
[`src/scopp/algorithm/auction.py`](../src/scopp/algorithm/auction.py),
[`src/scopp/algorithm/path_planning.py`](../src/scopp/algorithm/path_planning.py)이다.
